...
LEVEL levels [] = {
	{ 8, 4, 0, 3, 3, 99, map_bolts_0, tileset_0, enems_hotspots_0, behs_0_1 },
    { 8, 4, 0, 3, 3, 99, map_bolts_1, tileset_1, enems_hotspots_1, behs_0_1 },
    { 8, 4, 0, 3, 3, 99, map_bolts_2, tileset_2, enems_hotspots_2, behs_2 }
};
